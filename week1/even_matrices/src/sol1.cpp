...
/*
partial_sums: sum sur les colonnes, pas en diagonales!!
*/
    ...
    for (int i1=0; i1<n; i1++) {
        for (int i2=i1; i2<n; i2++) {
            ...
            for (int col=0; col<n; col++) {
                ...
                else col_sum = partial_sums[i2][col] - partial_sums[i1-1][col]; // donne justed la colonne!
