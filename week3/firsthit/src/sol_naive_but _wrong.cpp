...
/*
WA cause : if ray and obstable colinear, dont know if best inter is with source or target of obstacle.
Also TLE : too slow to check inter of each inter. Better: maintain a best_segment from source_ray to current_best_inter.
Then check inter between best_segment and obstacles.
*/
